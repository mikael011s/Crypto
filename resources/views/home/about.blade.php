                    ...
                    <div class="row gy-sm-5 gy-4 gx-xl-5 h-100 justify-content-between">
                        ...
                        <div class="col-sm-6 col-lg-6 col-xl-6">
                            <div class="feature__item__two style--two">
                                ...
                                <div class="feature__item__two-content">
                                    <h3 class="title mb-2">24/7 Поддержка</h3>
                                    <p>Мы консультируем и отвечаем на вопросы в режиме 24 часа в сутки 7 дней в неделю.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-6 col-xl-6">
                            <div class="feature__item__two style--two">
                                ...
                                <div class="feature__item__two-content">
                                    <h3 class="title mb-2">Безопасная система </h3>
                                    <p>Специалисты платформы создали многоуровневую защиту транзакций и внутреннего баланса в кошельке </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-6 col-xl-6">
                            <div class="feature__item__two style--two">
                                ...
                                <div class="feature__item__two-content">
                                    <h3 class="title mb-2">Гарантия дохода</h3>
                                    <p>Многолетний опыт инвестирования позволяет нам гарантированно обеспечивать рост RAu COIN </p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="choose__us__content">
                        <div class="section__header mb-0">
                            <h2 class="section__header-title">Корпорация MIKE GROUP эмитент RAu COIN </h2>
                        ...
                        </p>Бизнес индустрии куда корпорация MIKE GROUP инвестирует средства</p>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-10">
                    <div class="section__header text-center">
                        ...
                        <p>Инвесторы которые уже ощютили в своих кошельках прибыль от вложений в RAu COIN, и уже инвестируют существенные суммы.</p>
                    </div>
                </div>
            </div>
    ...
    <section class="faq-section padding-bottom overflow-hidden">
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-6">
                    <div class="section__header mb-0">
                        <h2 class="section__header-title">Остались вопросы ?</h2>
                ...
                <div class="col-lg-5 d-none d-lg-block">
                    <div class="section__thumb ">
                        <img src="/template-assets/digihyip/images/faq/thumb.png" alt="download">
                    </div>
                </div>
            </div>
        </div>
