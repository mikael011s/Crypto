                        ...
                        <div class="col-xl-8 col-lg-10">
                            <div class="faq__wrapper">
                                ...
                                <div class="faq__item">
                                    ...
                                    <div class="faq__item-content">
                                        <p>Для инвесторов предусмотрены несколько этапов реализации RAu COIN - через 3 месяца, 6 месяцев, 9 месяцев, и 12 месяцев и более </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-8 col-lg-10">
                            <div class="faq__wrapper">
                                <div class="faq__item">
                                    ...
                                    <div class="faq__item-content">
                                        <p> Если Вы не нашли ответа на вопрос в списке часто задаваемых, напишите в службу поддержки mail@redaurumcoin.ru</p>
                                    </div>
                                </div>
                            </div>
                        </div>
