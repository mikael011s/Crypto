            ...
            <div class="row justify-content-center">
                <div class="col-lg-10 col-xl-8">
                    ...
                    <div class="privacy__card" id="cookie">
                        ...
                        <ul class="info__list d-flex flex-wrap mt-3 mt-sm-4">
                        <p>В интернете можно найти множество предложений по вложениям и заработку, однако большинство из них мягко говоря мошеннические, а те проекты, котроые действительно рабочие, требуют внимания и тщательного изучения механизмов и правил для получения дохода.</p>
                        <ul class="info__list d-flex flex-wrap mt-3 mt-sm-4">
                        <p>Цель проекта RAu COIN - предоставить каждому желающему возможность зарабатывать в вне зависимости от его знаний, навыков и умений. Основную работу выполняют наши специалисты в области подбора инвестиционных проектов, и сопровождают данные проекты до получения максимальной прибыли. Поэтому денежные средтва полученные от реализации RAu COIN приносят стабильную прибыль. И соответсвенно растущий курс нашего токена дает возможность Вам получать доход не прикладывая каких либо услий.</p>
                        <ul class="info__list d-flex flex-wrap mt-3 mt-sm-4">
